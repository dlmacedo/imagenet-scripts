...
labels = open("devkit-1.0/data/ILSVRC2010_validation_ground_truth.txt").readlines()

# print(sorted(labels)[::-1])

for i in range(len(labels)):
    f.write("mv images/val/ILSVRC2010_val_{0:08d}.JPEG images/val/".format(i+1) + wnids[int(labels[i])] + "\n")
